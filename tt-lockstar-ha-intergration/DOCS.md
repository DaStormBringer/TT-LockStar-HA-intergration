...
- **Alpha.17 timing experiment**: Command-only connections use short, bounded retries instead of waiting 40–55 seconds on one stale HCI handle. Keep a manual fallback until this has passed repeated supervised timing tests.
